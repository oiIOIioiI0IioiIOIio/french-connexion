...
summary: Brigitte Macron est une personnalité publique française, connue pour être
  l'épouse d'Emmanuel Macron, président de la République française. Elle s'engage
  activement dans des causes sociales et éducatives, notamment en faveur de l'inclusion
  et de la jeunesse.
type: Personne
website: null
